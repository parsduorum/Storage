...
[600975005337.7,601033465318.2001] --квантили
------------------------------------------
...
[6798209858.2,7398406546.6,7787815346.6] --квантили
-------------------------------------------------------------
...
--02.03. Джойню 1 и 2 времянку чтобы найти заказы возвращенные в офис оформления
-------------------------------------------------------------
select quantiles(0.2, 0.4, 0.6, 0.8)(item_id)
from tmp.tmp_return_2_101  

[6407672208.2,7037351509.200001,7405243710.4,7783571344.2] --квантили
-------------------------------------------------------------
...
--02.04. Нахожу количество переупакованных заказов после возврата
...
--02.05. Отбираю товары, которые попали в другой заказ после возврата
[6407672208.2,7037351509.200001,7405243710.4,7783571344.2] --квантили
...
--02.06. Вычсиляю количество товаров из предыдущей времянки
